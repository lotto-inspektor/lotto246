...
function MediaShow(strType,strID,strURL,intWidth,intHeight,strPlay,strStop)
{
	...
	if(MediaTemp[strID]){
		...
		switch(strType){
			case "swf":
				tmpstr='<div style="height:6px;overflow:hidden"></div><object codebase="http://web.archive.org/web/20110207133037/http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="'+intWidth+'" height="'+intHeight+'"><param name="movie" value="'+strURL+'" /><param name="quality" value="high" /><param name="AllowScriptAccess" value="never" /></object>';
				break;
			case "flv":
			...
			case "wmv":
			case "asf":
				tmpstr='<div style="height:6px;overflow:hidden"></div><object classid="clsid:22D6F312-B0F6-11D0-94AB-0080C74C7E95" codebase="http://web.archive.org/web/20110207133037/http://activex.microsoft.com/activex/controls/mplayer/en/nsmp2inf.cab#Version=6,0,02,902" type="application/x-oleobject" standby="Loading..." width="'+intWidth+'" height="'+intHeight+'"><param name="FileName" VALUE="'+strURL+'" /><param name="ShowStatusBar" value="-1" /><param name="AutoStart" value="true" /><embed type="application/x-mplayer2" pluginspage="http://web.archive.org/web/20110207133037/http://www.microsoft.com/Windows/MediaPlayer/" src="'+strURL+'" autostart="true" width="'+intWidth+'" height="'+intHeight+'" /></object>';
				break;
			case "rm":
			case "rmvb":
			...
			case "avi":
				...
				break;
			case "divx":
				tmpstr='<div style="height:6px;overflow:hidden"></div><object classid="clsid:67DABFBF-D0AB-41fa-9C46-CC0F21721616" width="'+intWidth+'" height="'+intHeight+'" codebase="http://web.archive.org/web/20110207133037/http://go.divx.com/plugin/DivXBrowserPlugin.cab"><param name="src" value="'+strURL+'" /><embed type="video/divx" src="'+strURL+'" width="'+intWidth+'" height="'+intHeight+'" pluginspage="http://web.archive.org/web/20110207133037/http://go.divx.com/plugin/download/"></embed></object>';
				break;
			case "ra":
				tmpstr='<div style="height:6px;overflow:hidden"></div><object classid="clsid:CFCDAA03-8BE4-11CF-B84B-0020AFBBCCFA" id="RAOCX" width="450" height="60"><param name="_ExtentX" value="6694"><param name="_ExtentY" value="1588"><param name="AUTOSTART" value="true"><param name="SHUFFLE" value="0"><param name="PREFETCH" value="0"><param name="NOLABELS" value="0"><param name="SRC" value="'+strURL+'"><param name="CONTROLS" value="StatusBar,ControlPanel"><param name="LOOP" value="0"><param name="NUMLOOP" value="0"><param name="CENTER" value="0"><param name="MAINTAINASPECT" value="0"><param name="BACKGROUNDCOLOR" value="#000000"><embed src="'+strURL+'" width="450" autostart="true" height="60"></embed></object>';
				break;
			case "qt":
				tmpstr='<div style="height:6px;overflow:hidden"></div><embed src="'+strURL+'" autoplay="true" loop="false" controller="true" playeveryframe="false" cache="false" scale="TOFIT" bgcolor="#000000" kioskmode="false" targetcache="false" pluginspage="http://web.archive.org/web/20110207133037/http://www.apple.com/quicktime/" />';
		}
...
function WriteHeadFlash(Path,Width,Height,Transparent){
	 var Temp,T=""
	 Temp='<object classid="clsid:D27CDB6E-AE6D-11CF-96B8-444553540000" id="FlashH" codebase="http://web.archive.org/web/20110207133037/http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0" border="0" width="'+Width+'" height="'+Height+'">'
	 Temp+='<param name="movie" value="'+Path+'"/>'
	 Temp+='<param name="quality" value="High"/>'
	 Temp+='<param name="scale" value="ExactFit"/>'
	 if (Transparent) {Temp+=' <param name="wmode" value="transparent"/>';T='wmode="transparent"'}
	 Temp+='<embed src="'+Path+'" pluginspage="http://web.archive.org/web/20110207133037/http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" name="FlashH" width="'+Width+'" height="'+Height+'" quality="High"'+T+' scale="ExactFit"/>'
	 Temp+='</object>'
...
/*
     FILE ARCHIVED ON 13:30:37 Feb 07, 2011 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 14:32:02 Nov 28, 2019.
...
/*
playback timings (ms):
  load_resource: 476.279
  esindex: 0.017
  PetaboxLoader3.datanode: 126.309 (4)
  exclusion.robots.policy: 0.173
  CDXLines.iter: 14.556 (3)
  LoadShardBlock: 29.378 (3)
  captures_list: 63.613
  exclusion.robots: 0.186
  RedisCDXSource: 15.726
  PetaboxLoader3.resolve: 375.599
*/